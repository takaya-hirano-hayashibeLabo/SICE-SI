...
\usepackage[1.4]{bxpdfver} %出力pdfバージョンの指定
...
% タイトルと著者名
\title{\textbf{時定数の動的変動による \\ 広範な時間スケールに頑健なSpiking Neural Networkの構築}} % 和文タイトル
\name{○平野 貴也 (東北大学), 沓澤 京 (東北大学), 大脇 大 (東北大学), 林部 充宏 (東北大学)} % 著者名
\etitle{A Spiking Neural Network Robust to a Wide Range of Time Scales \\ through Dynamic Variations of Time Constants} % 英文タイトル
